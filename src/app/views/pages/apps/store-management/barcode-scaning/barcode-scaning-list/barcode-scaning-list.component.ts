...
@Component({
	...
	selector: 'kt-barcode-scaning-list',
	templateUrl: './barcode-scaning-list.component.html',
	styleUrls: ['./barcode-scaning-list.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class BarcodeScaningListComponent implements OnInit, OnDestroy {
	// Table fields
	dataSource: ProductsDataSource;
	displayedColumns = ['select', 'manufacture', 'VINCode', 'createdDate', 'status', 'actions'];
	...
	ngOnInit() {
		...
		**/
		...
		this.subheaderService.setTitle('Barcode and Scaning');
